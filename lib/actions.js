...
export async function createBooking(data) {
  try {
    return await createBookingInternal(data);
  } catch (err) {
...
async function createBookingInternal(data) {
  const db = readDB();
...
export async function createInquiry(data) {
  try {
    return await createInquiryInternal(data);
  } catch (err) {
...
async function createInquiryInternal(data) {
  const db = readDB();
  const inquiry = {
    id: genId("inq"),
    name: data.name,
